...
$host = 'localhost';
$dbname = 'digital_signature';  // Your database name
$username = 'root';  // Your database username
$password = 'mysqlVermelho1_';  // Your database password
...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['code'])) {
    ...
    try {
        ...
        $stmt = $pdo->prepare("SELECT item_name, stock FROM equipment WHERE item_code = :code");
